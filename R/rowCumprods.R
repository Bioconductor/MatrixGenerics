...
.matrixStats_rowCumprods <- function(x, rows = NULL, cols = NULL, dim. = dim(x), ..., useNames = NA){
  matrixStats::rowCumprods(x, rows = rows, cols = cols, dim. = dim., ..., useNames = isTRUE(useNames))
}
...
.matrixStats_colCumprods <- function(x, rows = NULL, cols = NULL, dim. = dim(x), ..., useNames = NA){
  matrixStats::colCumprods(x, rows = rows, cols = cols, dim. = dim., ..., useNames = isTRUE(useNames))
}
